package com.autoradio.push.test.jpush;
...
public class JPushClientExample {
	...
	private static final String appKey = "c5a408221a51e00693c5f6e9"; // 必填，例如466f7032ac604e02fb7bda89

	private static final String masterSecret = "b2aa721ab3609adb2b15c6e1";// "13ac09b17715bd117163d8a1";//必填，每个应用都对应一个masterSecret
	...
	private static void testSend() {
		...
		// msgTitle, msgContent, 0, extra,msgResult.getMsgid());

		if (null != msgResult) {
			System.err.println(msgResult.getErrcode());
			System.err.println(msgResult.getErrmsg());
			System.err.println(msgResult.getMsgid());
			System.err.println(msgResult.getSendno());
